...
Res <- getResData(Data.AggBySiteID.2,chemclass,LOQ.type = c("LOQ.T0","LOQ.T1"),
                  Exclusion.CAS = c("Excluded_None","Refined_Metals_PAH","Excluded_Metals","Current_Use","Banned_Listed"),Data.SSD.1)
stations1 <- Res %>% group_by(LOQ.type,Exclusion.CAS,monitoringSiteIdentifier) %>%
...
stations1 <- left_join(stations1,stations)
stations1$Exclusion.CAS <- factor(stations1$Exclusion.CAS,levels=c("Excluded_None","Refined_Metals_PAH","Excluded_Metals","Banned_Listed","Current_Use"))
...
Res <- getResData(Data.AggBySiteID.2,chemclass,LOQ.type = c("LOQ.T0","LOQ.T1"),
                  Exclusion.CAS = c("Excluded_None","Refined_Metals_PAH","Excluded_Metals_PAH","Current_Use"),Data.SSD.1)
