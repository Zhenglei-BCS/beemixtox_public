...
Stations = read.csv(paste0(Dir_Data,"Waterbase_v2019_1_S_WISE6_SpatialObject_DerivedData_repaired.csv")) # v2020
...
Data.AggBySiteID = read.csv(paste0(Dir_Data,"Waterbase_v2019_1_T_WISE6_AggregatedData.csv")) #2020 #3510775 rows
...
Data.AggBySiteID.1 = Data.AggBySiteID.1[Data.AggBySiteID.1$CAS%in%CAS.SSD.1,]; Data.AggBySiteID.1 = droplevels(Data.AggBySiteID.1) #1679005 entries
