...
if(interactive()){
  write.csv(table_chronic,file="inst/manuscript_v3/table_chronic.csv")
}
...
if(interactive()){
  write.csv(table_acute,file="inst/manuscript_v3/table_acute.csv")
}
```
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure1-Acute.png",width = 15,height=8,dpi=300)
}
```
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure1-Chronic.png",width = 15,height=8,dpi=300)
}
```
...
ggsave("inst/manuscript_v3/Figure1-final.png",width = 9,height=6,dpi=300)
if(interactive()){
  ggsave("inst/manuscript_v3/Figure1.png",width = 15,height=8,dpi=300)
}
```
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure2-Acute.png",width = 12,height=8,dpi=300)
}


ggplot(tmp_1,aes(x=N,y=HI_Acute))+geom_point(pch=".")+geom_hline(yintercept = 1,col="blue")+facet_grid(Ntype~LOQ.type+Exclusion.CAS)+ annotate("rect", xmin = 0, xmax = Inf, ymin = 0, ymax = 1,fill="yellow",alpha=0.2)+geom_quantile(method = "rqss", quantiles = c(0.1, 0.5, 0.95), colour = "red")+scale_y_log10()+geom_text(data=sumtmp_1,aes(x=x,y=y,label=paste0("II: ",formatC(Perc,digits = 1,format="f"),"%")),hjust=1)+geom_text(data=N_CAS_Site_1,aes(x=x,y=y,label=paste0("N.Site = ",N.Site,"\nN.CAS = ",N.CAS)),hjust=1)+scale_x_log10()
if(interactive()){
  ggsave("inst/manuscript_v3/Figure2-Acute-logxy.png",width = 12,height=8,dpi=300)
}
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure2-Acute-free_x.png",width = 12,height=8,dpi=300)
}
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure2-Chronic.png",width = 12,height=8,dpi=300)
}


ggplot(tmp_1,aes(x=N,y=HI_Chronic))+geom_point(pch=".")+geom_hline(yintercept = 1,col="blue")+facet_grid(Ntype~LOQ.type+Exclusion.CAS)+ annotate("rect", xmin = 0, xmax = Inf, ymin = 0, ymax = 1,fill="yellow",alpha=0.2)+geom_quantile(method = "rqss", quantiles = c(0.1, 0.5, 0.95), colour = "red")+scale_y_log10()+geom_text(data=sumtmp_1,aes(x=x,y=y,label=paste0("II: ",formatC(Perc,digits = 1,format="f"),"%")),hjust=1)+geom_text(data=N_CAS_Site_1,aes(x=x,y=y,label=paste0("N.Site = ",N.Site,"\nN.CAS = ",N.CAS)),hjust=1)+scale_x_log10()
if(interactive()){
  ggsave("inst/manuscript_v3/Figure2-Chronic-logxy.png",width = 12,height=8,dpi=300)
}
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure2-Chronic_free_x.png",width = 9,height=6,dpi=300)
}
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure3-Chronic.png",width = 12,height=5,dpi=300)
}
...
write.csv(table13,file="inst/manuscript_v3/table13_Chronic.csv")
```
...
p1
if(interactive()){
ggsave("inst/manuscript_v3/Figure3-Chronic-boxplot-sqrt.png",width = 12,height=8,dpi=300)
}
...
if(interactive()){
ggsave("inst/manuscript_v3/Figure3-Chronic-boxplot.png",width = 12,height=5,dpi=300)
}
```
...
if(interactive()){
  ggsave("inst/manuscript_v3/Figure3-Chronic-annotated.png",width = 10,height=4.5,dpi=300)
}
```
...
if(interactive()){
ggsave("inst/manuscript_v3/Figure3-Chronic-boxplot-Chronic-Site.Year-sqrt.png",width = 12,height=5,dpi=300)
}
...
if(interactive()){
ggsave("inst/manuscript_v3/Figure3-Chronic-boxplot-Chronic-Site.Year.png",width = 12,height=5,dpi=300)
}
```
...
# https://www.blopig.com/blog/2019/08/combining-inset-plots-with-facets-using-ggplot2/
if(interactive()){
  ggsave("inst/manuscript_v3/Figure3-Chronic-annotated-site-year.png",width = 12,height=5,dpi=300)
}
```
...
```{r}
write.csv(sumCAS,file="inst/manuscript_v3/table_fig4a.csv")
```
...
for(excludecas in c("Excluded_None","Refined_Metals_PAH", "Excluded_Metals","Current_Use")){
  ...
  if(interactive()){
    ggsave(paste0("inst/manuscript_v3/Figure4a-Chronic-",excludecas,".png"),width = 10,height=8,dpi=300)
  }
}
...
for(excludecas in c("Excluded_None","Refined_Metals_PAH", "Excluded_Metals","Current_Use")){
  ...
  if(interactive()){
    ggsave(paste0("inst/manuscript_v3/Figure4b-Chronic-",excludecas,".png"),width = 10,height=9,dpi=300)
  }
}
...
Exclusion.CAS <- "Excluded_Metals"
 HQdata <- getHQData_Chronic(Data.AggBySiteID.2,chemclass=chemclass,Data.SSD.1=Data.SSD.1,LOQ.type= c("LOQ.T0"),driverdata,Exclusion.CAS=Exclusion.CAS)
  ...
  write.csv(sumCAS1,file=paste0("inst/manuscript_v3/table_fig4b_",Exclusion.CAS,"_all.csv"))
