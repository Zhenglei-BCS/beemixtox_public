...
if(interactive()) ggsave("inst/manuscript/Paper_Figure2.pdf", width=12, height = 12, units = "in")
if(interactive()) ggsave("inst/manuscript/Paper_Figure2.png", width=12, height = 12, units = "in")
```
