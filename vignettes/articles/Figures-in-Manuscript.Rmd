...
library(kableExtra)
conf3 <- conf %>% rename(`Synery Factor 3`=synergy)
## conf %>% knitr::kable(., "markdown")
```
...
fig3
sim_H0 <- sim_H0+scale_color_manual(labels = c("30%","60%","100%","140%","300%"),values = scales::hue_pal()(5)) sim_H3 <- sim_H3+scale_color_manual(labels = c("30%","60%","100%","140%","300%"),values = scales::hue_pal()(5)) sim_H5 <- sim_H5+scale_color_manual(labels = c("30%","60%","100%","140%","300%"),values = scales::hue_pal()(5)) sim_H10 <- sim_H10+scale_color_manual(labels = c("30%","60%","100%","140%","300%"),values = scales::hue_pal()(5)) 
fig3 <- sim_H0+sim_H3+sim_H5+sim_H10+plot_annotation(tag_levels = 'A')+ plot_layout(guides = "collect")
fig3
