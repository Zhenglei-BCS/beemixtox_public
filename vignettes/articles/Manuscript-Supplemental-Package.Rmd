...
- We conducted the analysis for binary and tertiary mixtures.
...
```{r}
d95 %>% knitr::kable(.,caption="<strong>Table S3: 95th %tile of the Simulated MDRs based on additive mixture assumption (Same compound is being mixed with itself in the mixture)</strong>",
